...
namespace MemcardRex
{
    ...
    public class Save : ReactiveObject
    {
        ...
        private Avalonia.Media.Imaging.Bitmap _Region;
        public  Avalonia.Media.Imaging.Bitmap Region
        {
            get {   
                return _Region;
            }
    ...
    public  class ps1card : ReactiveObject
    {
        //Memory Card's name
        ...
        private Font _SavesFont;

        public Font SavesFont
        {
            get { return _SavesFont; }
            set
            {
                _SavesFont = value;
                this.RaisePropertyChanged();
