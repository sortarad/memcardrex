...
RUN /usr/local/./dmg dmg /tmp/MemcardRex_temp.dmg /dist/MemcardRex.dmg 
#Now DMG in /dist/MemcardRex.dmg
...
RUN cp -f /root/.wine/drive_c/Build/MemcardRex.msi /dist/MemcardRex.msi
#Now MSI in /dist/MemcardRex.msi
